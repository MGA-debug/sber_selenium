...
public class ParametrizedSber extends BaseTests {


    String baseUrl = "http://www.sberbank.ru/ru/person";

    @ParameterizedTest(name = "Тестик data" + DEFAULT_DISPLAY_NAME)
    @CsvSource({"Петров,Петр,Петрович,petr@mail.ru,+79111111111,02.03.2000,PETR PETROV",
            "Иванов,Иван,Иваныч,ivan@mail.ru,9222222222,03.04.2000,IVAN IVANOV",
            "Сидоров,Сидор,Сидорович,sidor@mail.ru,9333333333,04.05.2000,SIDOR SIDOROV"})
    void orderACardTest(String firstName, String lastName, String middleName, String email, String phoneNumber, String birthDate,String cardName) {
        ...
        String dateErrorInputXPath = "//input[@data-name='issueDate']/../../../div[text()='Обязательное поле']";
